...
RemoteControlTransmitterAddress::RemoteControlTransmitterAddress( const uint32_t channel ) :
    fifo( new SubValueRO( RMT_CH0ADDR_REG + 0x4 * channel, RMT_APB_MEM_RADDR_CH0_M, RMT_APB_MEM_RADDR_CH0_S ) ),
    ram( new SubValueRO( RMT_CH0STATUS_REG + 0x4 * channel, RMT_MEM_RADDR_EX_CH0_M, RMT_MEM_RADDR_EX_CH0_S ) ),
