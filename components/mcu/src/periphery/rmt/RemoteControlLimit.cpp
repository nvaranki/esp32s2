...
RemoteControlLimit::RemoteControlLimit( const uint32_t channel ) :
    //TODO ( new SubValueRW( RMT_CH0_TX_LIM_REG + 0x4 * channel, RMT_RX_LIM_CH0_M, RMT_RX_LIM_CH0_S ) ),
    threshold( new SubValueRW( RMT_CH0_TX_LIM_REG + 0x4 * channel, RMT_TX_LIM_CH0_M, RMT_TX_LIM_CH0_S ) ),
